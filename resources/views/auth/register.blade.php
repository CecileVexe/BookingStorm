<x-layout>    
    ...
    <div class="container mx-auto mt-10">
        ...
        <form method="post" action="{{route("register")}}">
            ...
            <div>
                <label for="name" class="block text-sm font-semibold leading-6 text-gray-900">Votre nom prénom</label>
                    @error("name")
            ...
            <div>
                <label for="password_confirmation" class="block text-sm font-semibold leading-6 text-gray-900">Confirmer votre mot de passe</label>
                  
                     <div class="mt-2.5">
                <input type="password" name="password_confirmation" id="password_confirmation" class="block border w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                     </div>
            </div>
            <div>
